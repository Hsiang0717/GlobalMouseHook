    ...
    public static partial class HookManager
    {
        ...
        private static int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
            if (nCode >= 0)
            {
                ...
                //µ¹¿é¤J¸Ë¸m
                var extraInfo = (ulong)mouseHookStruct.ExtraInfo.ToInt64();
                ...
                if (s_MouseClickExt != null && mouseDown)
                {
                ...
                {
                    e.Move_Delta = new System.Drawing.Point((mouseHookStruct.Point.X - m_OldX), (mouseHookStruct.Point.Y - m_OldY));
