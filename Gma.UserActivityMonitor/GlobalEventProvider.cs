...
namespace Gma.UserActivityMonitor
{
    ...
    public class GlobalEventProvider : Component
    {
        ...
        private event EventHandler<MouseEventExtArgs> m_MouseUpExt;
        ...
        public event EventHandler<MouseEventExtArgs> MouseUpExt
        {
            add
            {
                if (m_MouseUpExt == null)
                {
                    HookManager.MouseUpExt += HookManager_MouseUpExt;
                }
                m_MouseUpExt += value;
            }
        ...
        void HookManager_MouseUpExt(object sender, MouseEventExtArgs e)
        {
            if (m_MouseUpExt != null)
            {
                m_MouseUpExt.Invoke(this, e);
            }
        }
